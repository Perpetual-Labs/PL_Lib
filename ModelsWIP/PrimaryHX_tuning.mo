...
//  Operating Conditions:
  ...
  Modelica.Blocks.Interfaces.RealOutput BAin1_d annotation (
    Placement(visible = true, transformation(origin = {-90, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealOutput BAin1_T annotation (
    Placement(visible = true, transformation(origin = {-90, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {10, 130}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
