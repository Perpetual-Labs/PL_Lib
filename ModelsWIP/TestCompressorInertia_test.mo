...
model TestCompressorInertia_test
  ...
  ThermoPower.Gas.Compressor Compressor(redeclare package Medium = Medium, Ndesign = 523.3, Table = ThermoPower.Choices.TurboMachinery.TableTypes.matrix, Tdes_in = 244.4, Tstart_in = 244.4, Tstart_out = 691.4, explicitIsentropicEnthalpy = false, pstart_in = 0.35e5, pstart_out = 8.3e5, tableEta = tableEta, tablePR = tablePR, tablePhic = tablePhic) annotation(
