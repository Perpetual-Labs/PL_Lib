...
model HX_1DShellTube
  ...
  ThermoPower.Thermal.MetalTubeFV metalTubeFV1(
    ...
    rint=0.01/2) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=0)));
  ThermoPower.Thermal.HeatExchangerTopologyFV heatExchangerTopologyFV1(Nw=Nnodes - 1, redeclare model HeatExchangerTopology = ThermoPower.Thermal.HeatExchangerTopologies.ShellAndTube (
        Nw=Nnodes,
        Ntp=2,
        inletTubeAtTop=true,
        inletShellAtTop=true)) annotation (Placement(visible=true, transformation(
        origin={0,20},
        extent={{-10,-10},{10,10}},
        rotation=0)));
