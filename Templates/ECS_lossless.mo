...
equation
  ...
  connect(sensT_BA_PHXin.T, signalBus.signalSubBus_BA_T.T_BA_PHXin) annotation (Line(points={{-133,-30},{-130,-30},{-130,-120},{300.1,-120},{300.1,0.1}}, color={0,0,127}));
  connect(sensT_BA_PHXout.T, signalBus.signalSubBus_BA_T.T_BA_PHXout) annotation (Line(points={{-33,-34},{-30,-34},{-30,-118},{300.1,-118},{300.1,0.1}}, color={0,0,127}));
  connect(sensT_BA_SHXin.T, signalBus.signalSubBus_BA_T.T_BA_SHXin) annotation (Line(points={{47,-34},{50,-34},{50,-116},{300.1,-116},{300.1,0.1}}, color={0,0,127}));
  connect(sensT_BA_SHXout.T, signalBus.signalSubBus_BA_T.T_BA_SHXout) annotation (Line(points={{147,-34},{150,-34},{150,-114},{300.1,-114},{300.1,0.1}}, color={0,0,127}));
  connect(sensT_BA_PACKout.T, signalBus.signalSubBus_BA_T.T_BA_PACKout) annotation (Line(points={{227,-34},{230,-34},{230,-112},{300.1,-112},{300.1,0.1}}, color={0,0,127}));
  connect(sensT_RA_PHXin.T, signalBus.signalSubBus_RA_T.T_RA_PHXin) annotation (Line(points={{-133,50},{-126,50},{-126,120},{300.1,120},{300.1,0.1}}, color={0,0,127}));
  ...
  connect(sensP_RA_PHXin.p, signalBus.signalSubBus_RA_p.p_RA_PHXin) annotation (Line(points={{-103,56},{-94,56},{-94,100},{274,100},{274,0.1},{300.1,0.1}}, color={0,0,127}));
  connect(sensP_RA_PHXout.p, signalBus.signalSubBus_RA_p.p_RA_PHXout) annotation (Line(points={{-63,56},{-56,56},{-56,98},{272,98},{272,0.1},{300.1,0.1}}, color={0,0,127}));
  connect(sensP_RA_SHXin.p, signalBus.signalSubBus_RA_p.p_RA_SHXin) annotation (Line(points={{77,56},{86,56},{86,96},{270,96},{270,0.1},{300.1,0.1}}, color={0,0,127}));
  connect(sensP_RA_SHXout.p, signalBus.signalSubBus_RA_p.p_RA_SHXout) annotation (Line(points={{117,56},{124,56},{124,94},{268,94},{268,0.1},{300.1,0.1}}, color={0,0,127}));
  connect(sensT_RA_SHXin.T, signalBus.signalSubBus_RA_T.T_RA_SHXin) annotation (Line(points={{47,50},{52,50},{52,116},{300.1,116},{300.1,0.1}}, color={0,0,127}));
  ...
  connect(turbine.outlet, sensP_BA_PACKout.flange) annotation (Line(points={{196,-44},{208,-44},{208,-18},{210,-18},{210,-6}}, color={159,159,223}));
  connect(sensP_BA_PHXin.p, signalBus.signalSubBus_BA_p.p_BA_PHXin) annotation (Line(points={{-153,-4},{-150,-4},{-150,-100},{280,-100},{280,0.1},{300.1,0.1}}, color={0,0,127}));
  connect(sensP_BA_PHXout.p, signalBus.signalSubBus_BA_p.p_BA_PHXout) annotation (Line(points={{-23,6},{-20,6},{-20,-98},{278,-98},{278,0.1},{300.1,0.1}}, color={0,0,127}));
