...
model ECS_HEX1_extFun
  ...
  Modelica.Blocks.Sources.Ramp ramp_P_RAin(duration = 600, height = -74825, offset = 101325, startTime = 300) annotation(
    Placement(visible = true, transformation(origin = {-224, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  PL_Lib.Utilities.HX_extFun hX_extFun annotation(
    Placement(visible = true, transformation(origin = {-20, 2}, extent = {{-20, -28}, {20, 28}}, rotation = 0)));
protected
...
equation
  ...
  connect(ramp_P_RAin.y, sourceP_RAin.in_p0) annotation(
    Line(points = {{-213, 90}, {-206, 90}, {-206, 56.4}}, color = {0, 0, 127}));
  connect(ramp_P_RAin.y, sinkP_RAout1.in_p0) annotation(
    Line(points = {{-213, 90}, {59.55, 90}, {59.55, 45.95}}, color = {0, 0, 127}));
  ...
  connect(throughMassFlow_RAin.outlet, flowSplit.inlet) annotation(
    Line(points = {{-160, 50}, {-146, 50}}, color = {159, 159, 223}));
  ...
  connect(flowSplit.outlet1, throughMassFlow.inlet) annotation(
    Line(points = {{-134, 54}, {-120, 54}, {-120, 70}, {-40, 70}}, color = {159, 159, 223}));
  connect(ramp_P_RAin.y, sinkP_RAout2.in_p0) annotation(
    Line(points = {{-213, 90}, {183.55, 90}, {183.55, 45.95}}, color = {0, 0, 127}));
  ...
  connect(sourceP_RAin.flange, throughMassFlow_RAin.inlet) annotation(
    Line(points = {{-190, 50}, {-180, 50}}, color = {159, 159, 223}));
  connect(sourceP_BAin.flange, throughMassFlow_BAin.inlet) annotation(
    Line(points = {{-150, -40}, {-140, -40}}, color = {159, 159, 223}));
  ...
  connect(throughMassFlow.outlet, stateReader_RAin2.inlet) annotation(
    Line(points = {{-20, 70}, {80, 70}, {80, 40}, {94, 40}}, color = {159, 159, 223}));
  ...
  connect(hX_extFun.Tcold_out, pressureToMassFlowAdaptor2.T) annotation(
    Line(points = {{2, 20}, {20, 20}, {20, 54}, {34, 54}}, color = {0, 0, 127}));
  connect(hX_extFun.Pcold_out, pressureToMassFlowAdaptor2.p) annotation(
    Line(points = {{2, 12}, {22, 12}, {22, 48}, {34, 48}}, color = {0, 0, 127}));
  connect(hX_extFun.Thot_out, pressureToMassFlowAdaptor4.T) annotation(
    Line(points = {{2, -8}, {22, -8}, {22, -26}, {34, -26}}, color = {0, 0, 127}));
  connect(hX_extFun.Phot_out, pressureToMassFlowAdaptor4.p) annotation(
    Line(points = {{2, -16}, {20, -16}, {20, -32}, {34, -32}}, color = {0, 0, 127}));
  connect(massFlowToPressureAdaptor1.T, hX_extFun.RAin_T) annotation(
    Line(points = {{-94, 54}, {-48, 54}, {-48, 26}, {-42, 26}}, color = {0, 0, 127}));
  connect(massFlowToPressureAdaptor1.p, hX_extFun.RAin_p) annotation(
    Line(points = {{-94, 48}, {-50, 48}, {-50, 20}, {-42, 20}}, color = {0, 0, 127}));
  connect(massFlowToPressureAdaptor3.T, hX_extFun.BAin_T) annotation(
    Line(points = {{-94, -26}, {-54, -26}, {-54, -4}, {-42, -4}}, color = {0, 0, 127}));
  connect(massFlowToPressureAdaptor3.p, hX_extFun.BAin_p) annotation(
    Line(points = {{-94, -32}, {-52, -32}, {-52, -10}, {-42, -10}}, color = {0, 0, 127}));
  connect(pressureToMassFlowAdaptor2.m_dot, hX_extFun.RAin_mdot) annotation(
    Line(points = {{34, 26}, {24, 26}, {24, 40}, {-52, 40}, {-52, 14}, {-42, 14}}, color = {0, 0, 127}, thickness = 0.5));
  connect(pressureToMassFlowAdaptor4.m_dot, hX_extFun.BAin_mdot) annotation(
    Line(points = {{34, -54}, {-50, -54}, {-50, -16}, {-42, -16}}, color = {0, 0, 127}, thickness = 0.5));
  connect(massFlowToPressureAdaptor1.d, hX_extFun.RAin_d) annotation(
    Line(points = {{-94, 42}, {-60, 42}, {-60, 8}, {-42, 8}}, color = {0, 0, 127}));
  connect(massFlowToPressureAdaptor3.d, hX_extFun.BAin_d) annotation(
    Line(points = {{-94, -38}, {-48, -38}, {-48, -22}, {-42, -22}}, color = {0, 0, 127}));
  connect(pressureToMassFlowAdaptor2.m_dot, massFlowToPressureAdaptor1.m_dot) annotation(
    Line(points = {{34, 26}, {24, 26}, {24, 40}, {-54, 40}, {-54, 26}, {-94, 26}}, color = {0, 0, 127}, thickness = 0.5));
  connect(pressureToMassFlowAdaptor4.m_dot, massFlowToPressureAdaptor3.m_dot) annotation(
    Line(points = {{34, -54}, {-94, -54}}, color = {0, 0, 127}, thickness = 0.5));
  annotation(
