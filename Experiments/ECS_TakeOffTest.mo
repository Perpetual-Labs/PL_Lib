...
model ECS_TakeOffTest
  ...
  replaceable PL_Lib.Configurations.ECS_hybridConfig ECS_config(
  ...
  PL_Lib.Interfaces.SignalBus DataLogger annotation (Placement(
      visible=true,
      transformation(
        origin={60,0},
        extent={{-20,-20},{20,20}},
      ...
      iconTransformation(
        ...
        rotation=90)));
equation
  connect(inputP_cold_in.y, ECS_config.p_cold_in) annotation (Line(points={{-59,20},{-42,20},{-42,9},{-30,9}}, color={0,0,127}));
  connect(inputT_hot_in.y, ECS_config.T_hot_in) annotation (Line(points={{-59,-20},{-42,-20},{-42,-9},{-30,-9}}, color={0,0,127}));
  connect(inputP_hot_in.y, ECS_config.p_hot_in) annotation (Line(points={{-59,-60},{-40,-60},{-40,-24},{-30,-24}}, color={0,0,127}));
  connect(inputT_cold_in.y, ECS_config.T_cold_in) annotation (Line(points={{-59,60},{-40,60},{-40,24},{-30,24}}, color={0,0,127}));
