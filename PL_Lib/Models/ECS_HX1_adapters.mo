...
model ECS_HX1_adapters
  ...
  PL_Lib.Interfaces.MassFlowToPressureAdapter massFlowToPressureAdaptor3(redeclare package Medium = Medium) annotation (Placement(visible=true, transformation(
        ...
        extent={{-20,-20},{20,20}},
        rotation=0)));
  PL_Lib.Interfaces.MassFlowToPressureAdapter massFlowToPressureAdaptor4(redeclare package Medium = Medium) annotation (Placement(visible=true, transformation(
        origin={0,-40},
        extent={{-20,-20},{20,20}},
        rotation=0)));
  ...
  PL_Lib.Interfaces.PressureToMassFlowAdapter pressureToMassFlowAdaptor2(redeclare package Medium = Medium) annotation (Placement(visible=true, transformation(
        ...
        extent={{-20,-20},{20,20}},
        rotation=0)));
  PL_Lib.Interfaces.PressureToMassFlowAdapter pressureToMassFlowAdaptor3(redeclare package Medium = Medium) annotation (Placement(visible=true, transformation(
        origin={-60,-40},
        extent={{-20,-20},{20,20}},
        rotation=0)));
...
equation
  ...
  connect(flowSplit.outlet1, throughMassFlow.inlet) annotation (
    Line(points = {{-134, 54}, {-120, 54}, {-120, 80}, {-40, 80}}, color = {159, 159, 223}));
  ...
  connect(throughMassFlow.outlet, stateReader_RAin2.inlet) annotation (
    Line(points = {{-20, 80}, {80, 80}, {80, 40}, {94, 40}}, color = {159, 159, 223}));
  ...
  connect(pressureToMassFlowAdaptor3.flange, HEX1_BA.infl) annotation (
    Line(points = {{-56, -40}, {-40, -40}}, color = {159, 159, 223}));
  annotation (
    Diagram(coordinateSystem(extent = {{-240, -140}, {260, 160}}), graphics={  Text(origin = {-150, -20}, lineColor = {170, 0, 0}, extent = {{-30, 10}, {30, -10}}, textString = "Bleed air (hot side)", horizontalAlignment = TextAlignment.Left), Text(origin = {-164, 100}, lineColor = {0, 85, 255}, extent = {{-30, 10}, {30, -10}}, textString = "Ram air (cold side)",
