...
model TestGasFlow1DFV_A_CmprsrTest "Test case for Gas.Flow1DFV"
  ...
  ThermoPower.Gas.SourceMassFlow sourceMassFlow_gas1(redeclare package Medium = Medium, T = 273.15 + 200, p0 = 101325 * 2, use_in_T = false, w0 = 0.01) annotation (
  ...
  ThermoPower.Gas.Flow1DFV HEX1_gas1(redeclare package Medium = Medium, A = Ahex, Cfnom = Cfhex, Dhyd = Dihex, FFtype = ThermoPower.Choices.Flow1D.FFtypes.Cfnom, L = Lhex, N = Nnodes, Tstartbar = 273.15 + 200, Tstartin = 273.15 + 200, Tstartout = 273.15 + 200, dpnom = 1000, initOpt = ThermoPower.Choices.Init.Options.steadyState, omega = omegahex, pstart = phex, wnom = whex) annotation (
  ...
  ThermoPower.Gas.SourceMassFlow sourceMassFlow_gas2(redeclare package Medium = Medium, T = 273.15 + 25, use_in_T = true, use_in_w0 = false, w0 = 0.03) annotation (
  ...
  Modelica.Blocks.Sources.Ramp ramp_T_gas2in(duration = 600, height = -45, offset = 273.15 + 20, startTime = 300) annotation (
    Placement(visible = true, transformation(origin = {-170, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ThermoPower.Thermal.HeatExchangerTopologyFV heatExchangerTopologyFV1(Nw = Nnodes - 1) annotation (
    Placement(visible = true, transformation(origin = {-30, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ThermoPower.Gas.SinkPressure sinkP_gas1out(redeclare package Medium = Medium, p0 = 101325 * 2) annotation (
  ...
  ThermoPower.Gas.Flow1DFV HEX2_gas1(redeclare package Medium = Medium, A = Ahex, Cfnom = Cfhex, Dhyd = Dihex, FFtype = ThermoPower.Choices.Flow1D.FFtypes.Cfnom, L = Lhex, N = Nnodes, Tstartbar = 273.15 + 200, Tstartin = 273.15 + 200, Tstartout = 273.15 + 200, dpnom = 1000, initOpt = ThermoPower.Choices.Init.Options.steadyState, omega = omegahex, pstart = phex, wnom = whex) annotation (
...
equation
  ...
  connect(sensT_gas1out1.outlet, HEX2_gas1.infl) annotation (
    Line(points = {{36, -50}, {100, -50}}, color = {159, 159, 223}, thickness = 1));
  annotation (
