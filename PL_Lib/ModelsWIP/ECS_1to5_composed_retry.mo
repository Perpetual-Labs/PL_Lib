...
equation
  ...
  connect(Turbine.outlet, stateReader_BAout3.inlet) annotation (
    Line(points = {{198, -62}, {206, -62}, {206, -40}, {214, -40}}, color = {159, 159, 223}));
  ...
  connect(Compressor.shaft_b, inertia.flange_a) annotation (
    Line(points = {{16, -70}, {108, -70}}));
  connect(inertia.flange_b, Turbine.shaft_a) annotation (
    Line(points = {{128, -70}, {184, -70}}));
  connect(throughMassFlow.outlet, stateReader_RAin2.inlet) annotation (
    Line(points = {{-130, 60}, {26, 60}, {26, 40}, {34, 40}}, color = {159, 159, 223}));
  connect(PHX.outfl2, stateReader_BAout1.inlet) annotation (
    Line(points = {{-60, -10}, {-40, -10}, {-40, -40}, {-26, -40}}, color = {159, 159, 223}));
  connect(stateReader_RAin2.outlet, SHX.infl1) annotation (
    Line(points = {{46, 40}, {60, 40}, {60, 10}, {80, 10}}, color = {159, 159, 223}));
  connect(stateReader_BAin2.outlet, SHX.infl2) annotation (
    Line(points = {{46, -40}, {60, -40}, {60, -10}, {80, -10}}, color = {159, 159, 223}));
  connect(SHX.outfl1, stateReader_RAout2.inlet) annotation (
    Line(points = {{120, 10}, {140, 10}, {140, 40}, {154, 40}}, color = {159, 159, 223}));
  connect(SHX.outfl2, stateReader_BAout2.inlet) annotation (
    Line(points = {{120, -10}, {140, -10}, {140, -40}, {154, -40}}, color = {159, 159, 223}));
  connect(sensT1.outlet, PHX.infl1)
    annotation (Line(points={{-124,10},{-100,10}}, color={159,159,223}));
  connect(flowSplit.outlet2, sensT1.inlet) annotation (Line(points={{-164,46},{
          -150,46},{-150,10},{-136,10}}, color={159,159,223}));
  connect(throughMassFlow_BAin.outlet, sensT2.inlet)
    annotation (Line(points={{-160,-40},{-136,-40}}, color={159,159,223}));
  connect(sensT2.outlet, PHX.infl2) annotation (Line(points={{-124,-40},{-110,
          -40},{-110,-10},{-100,-10}}, color={159,159,223}));
  connect(PHX.outfl1, sensT3.inlet)
    annotation (Line(points={{-60,10},{-36,10}}, color={159,159,223}));
  connect(sensT3.outlet, sinkP_RAout1.flange) annotation (Line(points={{-24,10},
          {-10,10},{-10,40},{0,40}}, color={159,159,223}));
  annotation (
    Diagram(coordinateSystem(extent = {{-200, -140}, {200, 160}}), graphics={  Text(origin = {-190, -20}, lineColor = {170, 0, 0}, extent = {{-30, 10}, {30, -10}}, textString = "Bleed air (hot side)",
            horizontalAlignment =                                                                                                                                                                                              TextAlignment.Left), Text(origin = {-194, 80}, lineColor = {0, 85, 255}, extent = {{-30, 10}, {30, -10}}, textString = "Ram air (cold side)",
