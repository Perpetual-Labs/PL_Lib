...
model ECS_CabinTempVerification
  ...
  Modelica_Requirements.ChecksInSlidingWindow.MaxIncrease maxIncrease(upperLimit=3, window=3600) annotation (Placement(visible=true, transformation(extent={{-20,-100},{0,-80}},
                                                                                                                                                                               rotation=0)));
  Modelica.Blocks.Sources.RealExpression realExpression(y=DataLogger.signalSubBus_BA_T.T_BA_PACKout) annotation (Placement(transformation(extent={{-60,-100},{-40,-80}})));
equation
  connect(maxIncrease.y, R_TCabin.u) annotation (Line(points={{1,-90},{17.3333,-90}},
                                                                                   color={255,0,255}));
