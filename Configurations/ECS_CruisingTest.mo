...
equation
  connect(inputT_cold_in.y, sourceP_RAin.in_T) annotation (Line(points={{-273,82},{-230,82},{-230,59}}, color={0,0,127}));
  connect(inputP_cold_in.y, sourceP_RAin.in_p0) annotation (Line(points={{-273,52},{-266,52},{-266,56.4},{-236,56.4}}, color={0,0,127}));
  connect(inputT_hot_in.y, sourceP_BAin.in_T) annotation (Line(points={{-273,-18},{-230,-18},{-230,-31}}, color={0,0,127}));
  connect(inputP_hot_in.y, sourceP_BAin.in_p0) annotation (Line(points={{-273,-48},{-266,-48},{-266,-24},{-236,-24},{-236,-33.6}}, color={0,0,127}));
