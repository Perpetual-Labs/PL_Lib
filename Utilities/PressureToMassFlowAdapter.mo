...
equation
  ...
  annotation (
    Icon(graphics={  Rectangle(lineColor = {159, 159, 223}, fillColor = {255, 255, 255},
            ...
            lineThickness =                                                                                                               0.5, extent = {{-20, 100}, {20, -100}}, radius = 10), Text(origin = {0, 40}, extent = {{-20, 10}, {20, -10}}, textString = "p"), Text(origin = {0, 70}, extent = {{-20, 10}, {20, -10}}, textString = "T"), Text(origin = {0, -70}, extent = {{-20, 10}, {20, -10}}, textString = "m_dot")}));
