...
model MassFlowToPressureAdaptor
  ...
  ThermoPower.Gas.SinkPressure sinkP(redeclare package Medium = Medium, use_in_T = true, use_in_p0 = true) annotation(
...
equation
  ...
  connect(sensT.T, sinkP.in_T) annotation(
    Line(points = {{28, 10}, {34, 10}, {34, 38}, {60, 38}, {60, 10}}, color = {0, 0, 127}));
  annotation(
